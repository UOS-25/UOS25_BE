...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse response, String refreshToken) {
        storeRepository.findByRefreshToken(refreshToken)
                .ifPresent(user -> {
                    String reIssuedRefreshToken = reIssueRefreshToken(user);
                    jwtService.sendAccessAndRefreshToken(response, jwtService.createAccessToken(user.getCode()),
     ...
     * Flush
     */
    private String reIssueRefreshToken(Store store) {
        String reIssuedRefreshToken = jwtService.createRefreshToken();
        store.updateRefreshToken(reIssuedRefreshToken);
    ...
    public void checkAccessTokenAndAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        jwtService.extractAccessToken(request)
                .filter(jwtService::isTokenValid)
                .ifPresent(accessToken -> jwtService.extractCode(accessToken)
                        .ifPresent(code -> storeRepository.findByCode(code)
     ...
     * 인증 허가 처리
     */
    public void saveAuthentication(Store store) {
