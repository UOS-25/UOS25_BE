...
import com.uos25.uos25.auth.jwt.filter.JwtAuthenticationProcessingFilter;
...
public class SecurityConfig {
    ...
    public LoginSuccessHandler loginSuccessHandler() {
        return new LoginSuccessHandler(jwtService, storeRepository);
    }
    ...
    public JwtAuthenticationProcessingFilter jwtAuthenticationProcessingFilter() {
        return new JwtAuthenticationProcessingFilter(jwtService, storeRepository);
    }
